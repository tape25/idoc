...
import { Building2, ShieldCheck, FileText, ArrowRight, Zap, Globe, Clock } from "lucide-react"
      ...
      <header className="glass sticky top-0 z-50 w-full border-b border-white/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link href="/login">
              <Button variant="ghost" className="hidden sm:flex text-gray-600 hover:text-ivgreen-600 hover:bg-ivgreen-50 rounded-full px-6">
                Espace Agent
              </Button>
            </Link>
            <Link href="/login">
              <Button className="bg-ivgreen-600 hover:bg-ivgreen-700 text-white rounded-full px-6 shadow-lg shadow-ivgreen-600/30 transition-all hover:scale-105">
                Connexion
      ...
      <main className="flex-1 flex flex-col items-center justify-center relative z-10 px-4 sm:px-6 lg:px-8 pt-20 pb-32 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
          <Link href="/login" className="w-full sm:w-auto">
            <Button size="lg" className="w-full sm:w-auto bg-ivorange-500 hover:bg-ivorange-600 text-white rounded-full px-8 h-14 text-lg shadow-xl shadow-ivorange-500/30 transition-all hover:scale-105">
              Accéder au Portail
            </Button>
          </Link>
